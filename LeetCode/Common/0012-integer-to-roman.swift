...
private func intToRoman(_ num: Int) -> String {
    ...
    res.append(contentsOf: numArr[3][num / 1000])
    res.append(contentsOf: numArr[2][num % 1000 / 100])
    res.append(contentsOf: numArr[1][num % 100 / 10])
    res.append(contentsOf: numArr[0][num % 10])
